...
function addFriend(user, newFriend) {
  ...
  return Object.assign({}, user, { friends: user.friends.concat(newFriend) });
}
...
function sumUserPostLikes(user) {
  ...
  //return the sum
  return user.posts.reduce((acc, val) => acc + val.likes, 0);
}
...
function addCalculateDiscountPriceMethod(storeItem) {
  ...
  return Object.assign({}, storeItem, { calculateDiscountPrice: function() {
